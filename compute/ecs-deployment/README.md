...
2. **ECS Fargate** runs the **Flask container** pulled from my image.
3. **ALB** routes HTTP requests to my running container.
4. Output provides my **public ALB URL** to access the app.
